  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="font-body text-charcoal w-full max-w-full overflow-hidden" aria-label="Hovenier zoeken">
      <div className="flex flex-col gap-4 w-full">
        ...
        <button
          type="submit"
          className="flex items-center justify-center gap-2 w-full py-3.5 px-6 bg-primary-500 text-white rounded-md font-heading text-base font-bold cursor-pointer transition-colors duration-200 hover:bg-primary-600 active:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary-500 mt-1"
        >
          Vergelijk hoveniers
