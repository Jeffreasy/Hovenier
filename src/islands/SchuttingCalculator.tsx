    ...
    <div className="calc-wrapper">
      ...
      {step === 1 && (
        <div className="calc-step">
          ...
          <button className="calc-next-btn" onClick={() => setStep(2)} style={{ marginTop: '1.25rem' }}>
            Volgende →
          </button>
        </div>
      )}
...
export const sharedCalcStyles = `
  ...
  .quality-btn { display: flex; flex-direction: column; align-items: flex-start; gap: 0.25rem; padding: 0.875rem 1.25rem; border: 1px solid rgba(255,255,255,0.10); border-radius: 8px; background: rgba(255,255,255,0.05); cursor: pointer; text-align: left; transition: all 0.15s; width: 100%; }
  ...
  .calc-back-btn { padding: 0.75rem 1rem; background: transparent; border: 1px solid rgba(255,255,255,0.10); border-radius: 8px; color: rgba(237,242,236,0.45); font-size: 0.875rem; cursor: pointer; transition: all 0.15s; font-family: 'Inter', sans-serif; }
